    ...
    return (
        ...
        {[{text: "Trang chủ", link: "/"}, 
          ...
          <div key={i.text} className='relative text-center'  onMouseEnter={() => {i.text === "Sản phẩm" && setHover("")}} onMouseLeave={() => {i.text === "Sản phẩm" && setHover("hidden")}}>
            ...
            {i.text === "Sản phẩm" && <div className={'z-[1000] absolute border border-gray-200 text-sm w-64 left-0 top-10 bg-white flex flex-col justify-center items-center pb-2 shadow-[0_30px_30px_-15px_rgba(0,0,0,0.3)] text-yellow-950 ' + isHover}>
